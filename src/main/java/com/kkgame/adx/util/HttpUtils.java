...
//			System.out.println(entry.getKey()+":"+entry.getValue());
		...
		try {
			...
			logger.info("httpCon:" + httpCon);
			httpCon.setDoOutput(true);
			httpCon.setRequestMethod("GET");
			httpCon.setConnectTimeout(TIME_OUT * 30000);
			httpCon.setReadTimeout(TIME_OUT * 30000);
	...
	public static void main(String[] args) {
		String resp = HttpUtils.sentPost("http://121.201.34.67:8081/advnew/newservice/newopenOrSale.action", 
				"coo_id=11800&imei=352593052938670&sdk=4&xc_coo_id=11800&sdkversion=1090");
	}
}
