                                    ...
                                    <div class="row">
			                            <div class="col-sm-12" style="width: 80%;padding-left: 20%;">
			                                <form class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputName2" class="col-md-3 control-label">Dsp</label>
                                                    <div class="col-md-8">
                                                            <select id="dspId" class="form-control select2"
                                                                name="adPositionVO.dspId" >
                                                            </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
			                                    ...
			                                    <div class="form-group">
			                                        ...
			                                        <div class="col-md-8 form-inline">
		                                                <div class="checkbox checkbox-custom checkbox-circle">
	                                                        <input type="checkbox" name="searchVO.rowFields"  value="<s:property value="@com.kkgame.adx.data.bean.RowFieldVO@ROW_FIELD_DATE" />" checked="checked">
		                                                    <label for="datebox">Date</label>
		                                                </div>
		                                                <div class="checkbox checkbox-custom checkbox-circle">
                                                            <input type="checkbox" name="searchVO.rowFields"  value="<s:property value="@com.kkgame.adx.data.bean.RowFieldVO@ROW_FIELD_PUBLISHER" />">
                                                            <label for="datebox">Publisher</label>
                                                        </div>
                                                        <div class="checkbox checkbox-custom checkbox-circle">
                                                            <input type="checkbox" name="searchVO.rowFields"  value="<s:property value="@com.kkgame.adx.data.bean.RowFieldVO@ROW_FIELD_APP" />" >
                                                            <label for="datebox">APP</label>
                                                        </div>
                                                        <div class="checkbox checkbox-custom checkbox-circle">
                                                            <input type="checkbox" name="searchVO.rowFields"  value="<s:property value="@com.kkgame.adx.data.bean.RowFieldVO@ROW_FIELD_DSP" />" >
                                                            <label for="datebox">Dsp</label>
                                                        </div>
                                                        <div class="checkbox checkbox-custom checkbox-circle">
                                                            <input type="checkbox" name="searchVO.rowFields"  value="<s:property value="@com.kkgame.adx.data.bean.RowFieldVO@ROW_FIELD_ADPOSITION" />" >
                                                            <label for="datebox">ADPosition</label>
                                                        </div>
                                                        <div class="checkbox checkbox-custom checkbox-circle">
                                                            <input type="checkbox" name="searchVO.rowFields"  value="<s:property value="@com.kkgame.adx.data.bean.RowFieldVO@ROW_FIELD_COUNTRY" />" >
                                                            <label for="datebox">Country</label>
                                                        </div>
			                                        </div>
			                                    </div>
...
<script type="text/javascript">
	...
	$("#menu-5-3,#menu-5-3 a").addClass("active");
	...
	function searchList() {
            ...
            var myDate2 = new Date(date2[0],date2[1]-1,date2[2]);
                if (myDate1 <= myDate2) {
                    if(myDate1.getMonth()!=myDate2.getMonth()) {
                        showInfoToastMiddle("one month data only！");
                        return false;
                    }
                } else {
        ...
        var url="<%=request.getContextPath()%>/data/overallData!listPage";
